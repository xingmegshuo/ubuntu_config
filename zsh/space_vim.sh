...
fetch_repo () {
  if [[ -d "$HOME/.SpaceVim" ]]; then
    ...
    info "正在安装 SpaceVim..."
    git clone https://github.com.cnpmjs.org/SpaceVim/SpaceVim.git "$HOME/.SpaceVim"
...
install_package_manager () {
  if [[ ! -d "$HOME/.cache/vimfiles/repos/github.com/Shougo/dein.vim" ]]; then
    info "正在安装 dein.vim"
    git clone https://github.com.cnpmjs.org/Shougo/dein.vim.git $HOME/.cache/vimfiles/repos/github.com/Shougo/dein.vim
